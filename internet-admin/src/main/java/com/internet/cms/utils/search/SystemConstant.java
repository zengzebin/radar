...
public class SystemConstant {
	...
	public static String indexDir = "e:\\lucene\\luceneindex";

	public static String PDFdir = basedir + "datadir\\pdfdir\\";

	public static String PDFTxtdir = "e:\\lucene\\datadir\\pdftxtdir\\";

	public static String ConvertorPATH = "e:\\lucene\\xpdf\\bin32\\pdftotext";
