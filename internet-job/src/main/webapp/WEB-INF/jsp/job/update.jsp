			...
			<div class="row">
				...
				<sf:form method="post" modelAttribute="job" id="addForm" cssClass="form-horizontal" role="form">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<sf:input path="task_name" size="30" cssClass="col-xs-10 col-sm-5" placeholder="任务名称" />
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<sf:input path="job_class" size="30" cssClass="col-xs-10 col-sm-5" placeholder="job_class" />
					...
					<div class="form-group">
						...
						<div class="col-sm-9" >
							<sf:radiobutton path="execycle" value="1" onchange="selectExecycle(this)" cssStyle="padding-top:10px;" /> 执行周期
							<sf:radiobutton path="execycle" value="2" onchange="selectExecycle(this)" cssStyle="padding-top:10px;"/> cron表达式 
						</div>
					</div>
							...
							<div class="col-sm-9" >
								<span>
								 	<sf:select path="task_interval_unit" tbindex="1" onchange="selectUnit()">
										...
										<sf:option value="0">秒</sf:option>
									</sf:select>
								</span>
								
								<span id="intervalSecondSpan" style="display:none;">
									<sf:input path="interval_second" id="INTERVAL_SECOND" style="width:35px;"/> 秒
								</span>
...
$(function(){
	selectUnit();
	selectExecycle($("input[name='execycle']:checked").get(0))
// 	$("#addForm").cmsvalidate();
	...
	function controlInput(intervalUnitValue){
		...
		if(intervalUnitValue==0){
			$("#intervalSecondSpan").show();
			$("#intervalSecondInput").prop("disabled","");
		}else if(intervalUnitValue==1){
